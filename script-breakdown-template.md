...
| 10 | <span style="color:#ea580c"><strong>[BRANCH A2: Given what I hear so far, it looks like a realistic timeline to get to funding is likely [TIMELINE].]</strong></span> | Set a realistic timeline when the available information supports it |
...
| # | Verbatim / instruction | Reason / purpose |
| --- | --- | --- |
| 16 | <span style="color:#db2777"><strong>[EDUCATE / BUILD TRUST]</strong></span><br><br><span style="color:#2563eb"><em>"And this is something we hear all the time — the funding space is saturated... Because of that, it's going to be very important for us to build trust."</em></span> | Acknowledge market skepticism and explain why trust matters |
| 17 | <span style="color:#db2777"><strong>[TRUST PRE-OBJECTION HANDLING]</strong></span><br><br><span style="color:#7c3aed"><strong>"Let's suppose you felt like we were the perfect fit for your next step, and everything was a match on your end and we invited you in, what would you want to know about us, to feel comfortable investing in yourself through our program?"</strong></span> | Invite concerns before presenting the next step; surface the prospect's buying criteria |
| 18 | **FUNDING LEVEL CONFIRMATION — BELOW $100K:** <span style="color:#db2777"><strong>[FUNDING LEVEL, CLOSE LOOP]</strong></span><br><br><span style="color:#2563eb"><em>"So, like I said in the beginning, 10K is a little on the lower side for what we help our clients achieve. If we were able to get you maybe 30 to 50K, and up towards 100K for the long-term..."</em></span> | Reframe a small initial request against the program's intended funding scale |
| 19 | <span style="color:#db2777"><strong>[FUNDING LEVEL, CHECK]</strong></span>: <span style="color:#7c3aed"><strong>Would you be able to use that effectively?</strong></span> | Confirm the prospect can deploy a larger amount productively |
